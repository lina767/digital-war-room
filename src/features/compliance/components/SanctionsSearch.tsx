...
import { MATCH_LEVEL_STYLES, type SanctionsBatchResult, type SanctionsResponse } from "../types/compliance.types";

export function SanctionsSearch({ data }: { data: ConflictData | null }) {
  const { actorNames, canScreenActors } = useComplianceData(data);
...
export { SanctionsSearch as SanctionsSearchSection };
