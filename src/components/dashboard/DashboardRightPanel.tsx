  ...
  return (
    <aside
      className={`
          ...
          md:translate-x-0
          w-[min(18rem,90vw)] sm:w-72 md:min-w-[320px] md:flex-[1_1_56%] md:max-w-[520px] border-l border-border flex-shrink-0 p-4 flex flex-col overflow-y-auto bg-background
