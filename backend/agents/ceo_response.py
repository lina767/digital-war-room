...
def assemble_ceo_response(
    *,
    ...
    anomalies_rollup: Optional[List[Dict[str, Any]]] = None,
    ...
    response: Dict[str, Any] = {
        ...
        "briefing_interpretation": briefing_interpretation or "",
        "actors": actors,
        ...
        "anomalies_rollup": anomalies_rollup if isinstance(anomalies_rollup, list) else [],
        "pattern_flags": [],
